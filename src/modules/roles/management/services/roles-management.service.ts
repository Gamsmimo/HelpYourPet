...
export class RolesManagementService {
  ...
  /**
   * Crear relaciÃ³n veterinaria-veterinario
   */
  private async createVeterinariaVeterinario(idVeterinario: number, idVeterinaria: number) {
    // AquÃ­ deberÃ­as inyectar el servicio de veterinaria-veterinario
    // Por ahora, lo dejamos preparado
    console.log(`Creando relaciÃ³n: veterinario ${idVeterinario} - veterinaria ${idVeterinaria}`);
  }

  /**
   * Obtener vista segÃºn el rol del usuario
   */
